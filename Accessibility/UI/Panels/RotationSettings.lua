...
assert(Profile and Config and Fields,
...
-- PanelRotation resolves this panel's rotation from the option path AceConfig
-- stored in the widget userdata. Identical to RotationRules.PanelRotation.
function methods:PanelRotation()
